...
def plotVars( h1, h2, title=None ):
  ...
  tl.DrawLatexNDC( 0.6, 0.9, "#bf{ ttH had, BDT > 0.23 }" )
  tl.SetTextColor(kBlack)
  tl.DrawLatexNDC( 0.6, 0.85, "#bf{ ttH had, BDT < 0.10 }" )
...
sel1 = "(N_lep == 0)*(ntags_25_77>0)*(isPassed)*(BDThad > 0.23)*weightTotal"
sel2 = "(N_lep == 0)*(ntags_25_77>0)*(isPassed)*(BDThad < 0.10)*weightTotal"
